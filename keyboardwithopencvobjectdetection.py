...
if __name__ == "__main__":
    ...
    with olympe.Drone(DRONE_IP) as drone:
        ...
        drone.connection()
        time.sleep(2)
        p1 = subprocess.Popen(['python3', 'real-time-object-detection/cvobjectdetection.py', '--prototxt', 'real-time-object-detection/MobileNetSSD_deploy.prototxt.txt', '--model', 'real-time-object-detection/MobileNetSSD_deploy.caffemodel'])
        time.sleep(2)
