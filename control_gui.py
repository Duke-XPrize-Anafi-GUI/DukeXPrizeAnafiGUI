...
title = tk.Label(canvas, text="Flight Controller v1", font=('Century', 20), anchor='center')
...
left_img = left_button_image.resize((BUTTON_WIDTH, BUTTON_HEIGHT), Image.ANTIALIAS)
...
down_img = down_button_image.resize((BUTTON_WIDTH, BUTTON_HEIGHT), Image.ANTIALIAS)
...
l_rotate_img = l_rotate_button_image.resize((ROTATE_BUTTON_WIDTH, ROTATE_BUTTON_HEIGHT), Image.ANTIALIAS)
...
r_rotate_img = r_rotate_button_image.resize((ROTATE_BUTTON_WIDTH, ROTATE_BUTTON_HEIGHT), Image.ANTIALIAS)
r_rotate_photoImg =  ImageTk.PhotoImage(r_rotate_img)
r_rotate_button=Button(controlFrame, image = r_rotate_photoImg)
